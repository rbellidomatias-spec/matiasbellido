        ...
        <div className="max-w-6xl mx-auto">
          <div className="glass rounded-full px-5 md:px-8 py-3 flex items-center justify-between shadow-glow">
            <button
              ...
              className="font-display font-bold text-lg gradient-text shrink-0"
              aria-label="Inicio"
            >
              MB.
            </button>
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full hover:bg-white/5 transition-colors text-xs uppercase tracking-wider"
              >
